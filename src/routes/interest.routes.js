...
router.post('/', auth(Roles.Admin), createInterestSchema, awaitHandlerFactory(interestController.createInterest)); // localhost:3000/api/API_VERSION/interests
router.patch('/:id', auth(Roles.Admin), updateInterestSchema, awaitHandlerFactory(interestController.updateInterest)); // localhost:3000/api/API_VERSION/interests/1 , using patch for partial update
