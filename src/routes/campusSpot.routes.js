...
router.post('/', auth(Roles.Admin), createCampusSpotSchema, awaitHandlerFactory(campusSpotController.createCampusSpot)); // localhost:3000/api/API_VERSION/campus-spots
router.patch('/:id', auth(Roles.Admin), updateCampusSpotSchema, awaitHandlerFactory(campusSpotController.updateCampusSpot)); // localhost:3000/api/API_VERSION/campus-spots/1 , using patch for partial update
