...
router.post('/', auth(Roles.Admin), createCampusSchema, awaitHandlerFactory(campusController.createCampus)); // localhost:3000/api/API_VERSION/campuses
router.patch('/:id', auth(Roles.Admin), updateCampusSchema, awaitHandlerFactory(campusController.updateCampus)); // localhost:3000/api/API_VERSION/campuses/1 , using patch for partial update
