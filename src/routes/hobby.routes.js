...
router.post('/', auth(Roles.Admin), createHobbySchema, awaitHandlerFactory(hobbyController.createHobby)); // localhost:3000/api/API_VERSION/hobbies
router.patch('/:id', auth(Roles.Admin), updateHobbySchema, awaitHandlerFactory(hobbyController.updateHobby)); // localhost:3000/api/API_VERSION/hobbies/1 , using patch for partial update
