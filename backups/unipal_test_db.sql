...
INSERT INTO `posts` (`post_id`, `body`, `privacy`, `posted_at`, `author_erp`) VALUES
(1, 'Some post content body', 'public', '2021-09-17 15:53:40', '17855'),
(2, 'Some post content body', 'public', '2021-09-17 16:53:40', '17855'),
(3, 'Some post content body', 'public', '2021-09-17 17:53:40', '17855'),
(4, 'Some post content body', 'private', '2021-09-17 15:55:40', '15030'),
(5, 'Some post content body', 'public', '2021-09-17 17:55:40', '15030'),
(6, 'Some post content body', 'limited', '2021-09-17 18:55:40', '15030'),
(7, 'Some post content body', 'public', '2021-09-17 16:56:40', '17619'),
(8, 'Some post content body', 'public', '2021-09-17 18:58:40', '17619'),
(9, 'Some post content body', 'public', '2021-09-17 18:58:40', '17619');
...
INSERT INTO `post_reactions` (`post_id`, `reaction_type_id`, `student_erp`, `reacted_at`) VALUES
(1, 2, '15030', '2021-09-17 15:53:40'),
(1, 2, '17619', '2021-09-17 15:53:40'),
(2, 4, '15030', '2021-09-17 15:53:40'),
(2, 4, '17619', '2021-09-17 15:53:40'),
(2, 2, '17855', '2021-09-17 15:53:40'),
(3, 2, '15030', '2021-09-17 15:53:40'),
(3, 2, '17855', '2021-09-17 15:53:40'),
(4, 1, '17619', '2021-09-17 15:53:40'),
(4, 2, '17855', '2021-09-17 15:53:40'),
(5, 2, '15030', '2021-09-17 15:53:40'),
(6, 2, '15030', '2021-09-17 15:53:40'),
(6, 4, '17619', '2021-09-17 15:53:40'),
(6, 2, '17855', '2021-09-17 15:53:40'),
(7, 5, '15030', '2021-09-17 15:53:40'),
(7, 5, '17619', '2021-09-17 15:53:40'),
(7, 5, '17855', '2021-09-17 15:53:40'),
(8, 2, '15030', '2021-09-17 15:53:40'),
(8, 1, '17619', '2021-09-17 15:53:40'),
(8, 2, '17855', '2021-09-17 15:53:40');
...
INSERT INTO `post_resources` (`post_id`, `resource_id`, `resource_type`, `resource_url`) VALUES
(1, 1, 'image', 'www.google.com/images'),
(1, 2, 'video', 'www.youtube.com'),
(2, 3, 'image', 'www.google.com/images'),
(2, 4, 'video', 'www.youtube.com'),
(3, 5, 'image', 'www.google.com/images'),
(3, 6, 'video', 'www.youtube.com'),
(5, 7, 'image', 'www.google.com/images'),
(5, 8, 'video', 'www.youtube.com'),
(6, 9, 'image', 'www.google.com/images'),
(6, 10, 'video', 'www.youtube.com'),
(7, 11, 'image', 'www.google.com/images'),
(7, 12, 'video', 'www.youtube.com'),
(8, 13, 'image', 'www.google.com/images'),
...
INSERT INTO `reaction_types` (`reaction_type_id`, `reaction_type`) VALUES
(1, 'Laugh'),
(2, 'Sad'),
(3, 'Angry'),
(4, 'Like'),
...
('17855', 'Abdur Rafay', 'Saleem', 'male', '+923009999999', 'arafaysaleem@gmail.com', '1999-09-18', '$2a$08$.XfuFmy6tAtNI4RJmNsY5O.InhSzUB2ZzVn9QO34.c9mDktfV73DG', 'https://i.pinimg.com/564x/8d/e3/89/8de389c84e919d3577f47118e2627d95.jpg', 2022, 'a.rafay.17855@iba.khi.edu.pk', 1, 2, 3, 1, 2, 3, 1, 1, 'CED', 'Lifting', 1, 1, 'api_user');
...
--
-- Indexes for table `post_resources`
--
ALTER TABLE `post_resources`
...
--
ALTER TABLE `hangout_requests`
  MODIFY `hangout_request_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
-- AUTO_INCREMENT for table `post_resources`
--
ALTER TABLE `post_resources`
  MODIFY `resource_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `reaction_types`
  MODIFY `reaction_type_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `student_connections`
--
ALTER TABLE `student_connections`
  MODIFY `student_connection_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT for table `student_statuses`
--
ALTER TABLE `student_statuses`
  MODIFY `student_status_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `posts`
  ADD CONSTRAINT `fk_posts_student_erp` FOREIGN KEY (`author_erp`) REFERENCES `students` (`erp`) ON DELETE CASCADE;

--
-- Constraints for table `post_reactions`
--
ALTER TABLE `post_reactions`
  ADD CONSTRAINT `fk_post_reactions_post_id` FOREIGN KEY (`post_id`) REFERENCES `posts` (`post_id`) ON DELETE CASCADE,
  ...
  ADD CONSTRAINT `fk_post_reactions_student_erp` FOREIGN KEY (`student_erp`) REFERENCES `students` (`erp`) ON DELETE CASCADE;

--
-- Constraints for table `post_resources`
--
ALTER TABLE `post_resources`
  ADD CONSTRAINT `fk_post_uploads_post_id` FOREIGN KEY (`post_id`) REFERENCES `posts` (`post_id`) ON DELETE CASCADE;
